...
-- Χρόνος δημιουργίας: 03 Μάη 2023 στις 12:30:21
...
--
-- AUTO_INCREMENT για πίνακα `book_to_author`
--
ALTER TABLE `book_to_author`
...
ALTER TABLE `book_to_author`
  ...
  ADD CONSTRAINT `FK_BOOK_ISBN` FOREIGN KEY (`ISBN`) REFERENCES `book` (`ISBN`);
...
ALTER TABLE `book_to_category`
  ...
  ADD CONSTRAINT `FK_CATEGORY_ISBN` FOREIGN KEY (`ISBN`) REFERENCES `book` (`ISBN`);
