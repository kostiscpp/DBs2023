...
('Πρότυπο ΕΠΑΛ Ηγουμενίτσας','Εθνικης Αντιστασεως','Ηγουμενίτσα',2665023521,'1epal-igoum.thesp.sch.gr','Τζάνης Νικόλαος','Οπερέιτορας 1'),
('2ο Γενικό Λύκειο Ηγουμενίτσας','49 Μαρτύρων','Ηγουμενίτσα',2665025644,'mail@2lyk-igoum.thesp.sch.gr','Νάκος Χρήστος','Οπερέιτορας 2');
...
call AddBook( '9780749397548','Captain Corelli''s Mandolin','De Bernieres, Louis','Minerva','1995','General & Literary Fiction','Fiction Mandolin',2,37,'800.xx',(FLOOR(RAND() * 300)+100));
call AddBook( '9780563384304','Delia''s How to Cook:(Bk.) ','Smith, Delia','BBC Books (Random House)','1998','Fitness & Diet','Cooking Fitness',2,38,'800.xx',(FLOOR(RAND() * 300)+100));
...
call AddBook( '9780141030142','Memory Keeper''s Daughter,The','Edwards, Kim','Penguin Books','2007','General & Literary Fiction','Memory',3,1,'800.xx',(FLOOR(RAND() * 300)+100));
...
call AddBook( '9780563384311','Delia''s How to Cook:(Bk.3) ','Smith, Delia','BBC Books (Random House)','1999','Fitness & Diet','Fitness Cooking',3,64,'800.xx',(FLOOR(RAND() * 300)+100));
...
INSERT INTO checkout (checkout_time,return_time, book_copy_id, user_id,checkout_status)
VALUES
('2023-01-10','2023-01-15', 1, 9,'returned'),
('2023-01-10','2023-01-15', 1, 10,'returned'),
('2023-01-10','2023-01-15', 1, 21,'returned'),
('2023-01-10','2023-01-15', 1, 22,'returned'),
('2023-01-10','2023-01-15', 2, 23,'returned'),
('2023-01-10','2023-01-15', 3, 33,'returned'),
('2023-01-10','2023-01-15', 4, 34,'returned'),
('2023-01-10','2023-01-15', 5, 40,'returned'),
('2023-01-10','2023-01-15', 6, 49,'returned'),
('2023-01-10','2023-01-15', 7, 50,'returned'),
('2023-01-10','2023-01-15', 8, 51,'returned'),
('2023-01-10','2023-01-15', 100, 23,'returned'),
('2023-01-10','2023-01-15', 101, 33,'returned'),
('2023-01-10','2023-01-15', 102, 34,'returned'),
('2023-01-10','2023-01-15', 103, 40,'returned'),
('2023-01-10','2023-01-15', 104, 49,'returned'),
('2023-01-10','2023-01-15', 105, 50,'returned'),
('2023-01-10','2023-01-15', 106, 51,'returned'),
('2023-01-10','2023-01-15', 9, 52,'returned'),
('2023-01-10','2023-01-15', 10, 53,'returned'),
('2023-01-10','2023-01-15', 11, 54,'returned'),
('2023-01-10','2023-01-15', 12, 55,'returned'),
('2023-01-10','2023-01-15', 13, 56,'returned'),
('2023-01-10','2023-01-15', 13, 80,'returned'),
('2023-01-10','2023-01-15', 14, 81,'returned'),
('2023-01-10','2023-01-15', 15, 82,'returned'),
('2023-01-10','2023-01-15', 16, 83,'returned'),
('2023-01-10','2023-01-15', 17, 84,'returned'),
('2023-01-10','2023-01-15', 18, 86,'returned'),
('2023-01-10','2023-01-15', 19, 8,'returned'),
('2023-01-10','2023-01-15', 20, 11,'returned'),
('2023-01-10','2023-01-15', 21, 12,'returned'),
('2023-01-10','2023-01-15', 22, 24,'returned'),
('2023-01-10','2023-01-15', 23, 25,'returned'),
('2023-01-10','2023-01-15', 24, 26,'returned'),
('2023-01-10','2023-01-15', 25, 35,'returned'),
('2023-01-10','2023-01-15', 26, 36,'returned'),
('2023-01-10','2023-01-15', 27, 41,'returned'),
('2023-01-10','2023-01-15', 28, 57,'returned'),
('2023-01-10','2023-01-15', 29, 58,'returned'),
('2023-01-10','2023-01-15', 30, 59,'returned'),
('2023-01-10','2023-01-15', 31, 60,'returned'),
('2023-01-10','2023-01-15', 32, 61,'returned'),
('2023-01-10','2023-01-15', 33, 62,'returned'),
('2023-01-10','2023-01-15', 34, 63,'returned'),
('2023-01-10','2023-01-15', 35, 64,'returned'),
('2023-01-10','2023-01-15', 36, 88,'returned'),
('2023-01-10','2023-01-15', 37, 89,'returned'),
('2023-01-10','2023-01-15', 38, 90,'returned'),
('2023-01-10','2023-01-15', 37, 89,'returned'),
('2023-01-10','2023-01-15', 37, 94,'returned');
